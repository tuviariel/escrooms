...
export const DigitalNumber = (props: DigitalNumberProps) => {
    ...
    return (
        <div
            ...
            } h-60 flex flex-col items-center justify-center bg-gray-100`}>
            {/* Top horizontal line */}
            <div
                ...
                {number[0]?.elem.startsWith("http") ? (
                    <img src={number[0]?.elem} alt="" className="" />
                ) : (
            ...
            <div
                ...
                {number[1]?.elem.startsWith("http") ? (
                    <img src={number[1]?.elem} alt="" className="" />
                ) : (
            ...
            <div
                ...
                {number[2]?.elem.startsWith("http") ? (
                    <img src={number[2]?.elem} alt="" className="" />
                ) : (
            ...
            <div
                ...
                {number[3]?.elem.startsWith("http") ? (
                    <img src={number[3]?.elem} alt="" className="" />
                ) : (
            ...
            <div
                ...
                {number[4]?.elem.startsWith("http") ? (
                    <img src={number[4]?.elem} alt="" className="" />
                ) : (
            ...
            <div
                ...
                {number[5]?.elem.startsWith("http") ? (
                    <img src={number[5]?.elem} alt="" className="" />
                ) : (
            ...
            <div
                ...
                {number[6]?.elem.startsWith("http") ? (
                    <img src={number[6]?.elem} alt="" className="" />
                ) : (
