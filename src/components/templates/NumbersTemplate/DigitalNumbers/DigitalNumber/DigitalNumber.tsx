...
export const DigitalNumber = (props: DigitalNumberProps) => {
    const { position, number, toggleSegment, amount } = props; //, category
    // console.log(number);
    return (
        <div
            className={`relative ${
            ...
            <div
                ...
                } h-8 rounded-b-3xl ${number[0]?.status ? "bg-[#E50113]" : "bg-[#535353]"}`}
                onClick={() => toggleSegment(position, 0)}>
                {number[0]?.elem.startsWith("http") || number[0]?.elem.startsWith("/src") ? (
                    <img
                        src={number[0]?.elem}
                        alt=""
                        className="bg-white rounded-b-lg h-8 w-8 m-auto"
                    />
                ) : (
                    <div className="bg-white rounded-b-lg h-6 w-6 m-auto">{number[0]?.elem}</div>
                )}
            </div>
            ...
            <div
                className={`absolute cursor-pointer hover:bg-blue-500 top-8 left-6 w-6 h-18 rounded-r-full content-center ${
                    number[1]?.status ? "bg-[#E50113]" : "bg-[#535353]"
                }`}
                ...
                {number[1]?.elem.startsWith("http") || number[1]?.elem.startsWith("/src") ? (
                    <img
                        src={number[1]?.elem}
                        alt=""
                        className="bg-white rounded-b-lg h-8 w-8 m-auto mt-4"
                    />
                ) : (
                    <div className="bg-white rounded-b-lg text-center rotate-270 h-6 w-6 m-auto">
                        {number[1]?.elem}
                    </div>
                )}
            </div>
            ...
            <div
                className={`absolute cursor-pointer hover:bg-blue-500 top-8 right-6 w-6 h-18 rounded-l-full content-center ${
                    number[2]?.status ? "bg-[#E50113]" : "bg-[#535353]"
                }`}
                ...
                {number[2]?.elem.startsWith("http") || number[2]?.elem.startsWith("/src") ? (
                    ...
                    <div className="rotate-90 bg-white rounded-b-lg text-center h-6 w-6 m-auto">
                        {number[2]?.elem}
                    </div>
                )}
            </div>
            ...
            <div
                className={`absolute cursor-pointer hover:bg-blue-500 top-25 left-6 content-center ${
                    amount < 4 ? "w-14 sph:w-22 ph:w-28" : "w-16 ph:w-20 sm:w-24 md:w-28"
                } h-8 rounded-full ${number[3]?.status ? "bg-[#E50113]" : "bg-[#535353]"}`}
                ...
                {number[3]?.elem.startsWith("http") || number[3]?.elem.startsWith("/src") ? (
                    ...
                    <div className="bg-white rounded-b-lg text-center h-6 w-6 m-auto">
                        {number[3]?.elem}
                    </div>
                )}
            </div>
            ...
            <div
                className={`absolute cursor-pointer hover:bg-blue-500 bottom-8 left-6 w-6 h-20 rounded-r-full content-center ${
                    number[4]?.status ? "bg-[#E50113]" : "bg-[#535353]"
                }`}
                ...
                {number[4]?.elem.startsWith("http") || number[4]?.elem.startsWith("/src") ? (
                    ...
                    <div className="rotate-270 bg-white rounded-b-lg text-center h-6 w-6 m-auto">
                        {number[4]?.elem}
                    </div>
                )}
            </div>
            ...
            <div
                className={`absolute cursor-pointer hover:bg-blue-500 bottom-8 right-6 w-6 h-20 rounded-l-full content-center ${
                    number[5]?.status ? "bg-[#E50113]" : "bg-[#535353]"
                }`}
            ...
            <div
                className={`absolute cursor-pointer hover:bg-blue-500 bottom-2 left-6 content-center ${
                    amount < 4 ? "w-14 sph:w-22 ph:w-28" : "w-16 ph:w-20 sm:w-24 md:w-28"
                } h-8 rounded-t-3xl ${number[6]?.status ? "bg-[#E50113]" : "bg-[#535353]"}`}
                ...
                {number[6]?.elem.startsWith("http") || number[6]?.elem.startsWith("/src") ? (
                    ...
                    <div className="bg-white rounded-b-lg h-6 w-6 m-auto text-center items-center">
                        {number[6]?.elem}
                    </div>
                )}
            </div>
