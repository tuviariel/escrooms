...
export const dummyQuizzes = [
    {
        ...
        hints: {
            hints: [
                "המקרה, הפעולה או העובדה בצידו הימני של הטבלה יכולה להיות נכונה או לא נכונה",
                "צריך להדגיש את האייקון שמופיע בתשובה הנכונה לפי המקרה",
                "ניתן ללחוץ על תשובה הנכונה בטבלה והאייקון המתאים יודגש מעצמו",
                "לאחר שעניתם נכונה על כל המקרים תוכלו לזהות את הספרות של התשובה",
                "אם אין ספרה מובנת כנראה שלא עניתם בצורה נכונה - ניתן לבדוק  בלחיצת הכפתור",
            ],
        },
    },
    {
        ...
        hints: {
            hints: [
                "ישנם מגוון מוצרים שפזורים בטבלה. בחרו את המוצרים שקשורים לנושא החדר.",
                "שימו לב לכלול את כל מה שיכול להועיל לך במשימה שלך",
                "לאחר שסיימתם לבחור את כל הפריטים שימו לב לתבנית שהם יוצרים",
                "נסו לזהות מספרים או אותיות מודגשות",
            ],
    ...
    },
    {
        ...
        hints: {
            hints: [
                "לחצו על הדפים השונים ובחרו את ההגדרה הנכונה לסיטואציה",
                "כמובן, שצריך לסיים לתייג את כל הדפים",
                "עברו לדף המקביל- ניתן לספור על הצבעים",
                "יש לספור את המופעים של כל צבע - זהו הצופן",
            ],
        },
    },
    {
        ...
        hints: {
            hints: [
                "תגררו את הכרטיסיות לסדר הנכון",
                "לאחר ששלבי הפעולה הם בסדר הנכון הגרירה מתבטלת וניתן ללמוד עוד על הסדר שמצאתם",
                "חפשו את הצופן על המסך",
                "הספרות מתגלות מתוך המסגרות",
            ],
        },
    },
